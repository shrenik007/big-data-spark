...
def my_model(spark, monitoring_dir, checkpoint_dir, result_dir, time_step_interval):
    ...
    # 7. Operation T4: We drop the duplicate entries
    solutionSDF = wordsSDF.dropDuplicates(["word", "my_time"])

    # 9. Operation O1: We create the DataStreamWritter, to print by console the results in complete mode
