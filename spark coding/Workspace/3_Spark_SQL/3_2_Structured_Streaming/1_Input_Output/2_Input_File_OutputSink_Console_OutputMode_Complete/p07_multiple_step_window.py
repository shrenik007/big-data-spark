...
if __name__ == '__main__':
    ...
    # 3.3. window_duration, i.e., how many previous batches of data are considered on each window.
    window_duration = 2

    # 3.4. sliding duration, i.e., how frequently the new DStream computes results.
    sliding_duration = 1

    # 3.5. We configure verbosity during the program run
    verbose = False
