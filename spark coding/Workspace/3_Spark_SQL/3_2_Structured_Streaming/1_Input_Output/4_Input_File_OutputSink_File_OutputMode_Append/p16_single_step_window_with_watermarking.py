...
# FUNCTION my_model
# ------------------------------------------
def my_model(spark, monitoring_dir, checkpoint_dir, result_dir, time_step_interval, my_timestamp):
...
def my_main(spark,
    ...
    dsw = my_model(spark, monitoring_dir, checkpoint_dir, result_dir, time_step_interval, my_timestamp)
...
if __name__ == '__main__':
    ...
    # 3.3. We get the current timestamp at the beginning of the program, to assign it to each Row of a DataFrame
